		...
		<>
			<div className="row">
				<button
					...
					data-cy="toggle-answer-type-to-image-btn"
				>
					<FaFileImage />
				</button>
				<button
					...
					data-cy="toggle-answer-type-to-audio-btn"
				>
					<MdAudioFile />
				</button>
			</div>
			<FileInput
				...
				//an error that I cannot fix, the second argument of the function is always the first answer from the question
